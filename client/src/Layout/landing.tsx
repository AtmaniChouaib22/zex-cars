  ...
  <div className="container">
    ...
    <div className="col">
      ...
      <div className="info">
        ...
        <p>
          Our customer care team exists to provide ongoing, excellent service
          and operates:<strong>Mondays</strong> to
    ...
    <div className="box-content">
      ...
      <div className="box">
        ...
        <ul>
          ...
          <li>
            <a href="#">Car finance calculator </a>
          </li>
          <li>
